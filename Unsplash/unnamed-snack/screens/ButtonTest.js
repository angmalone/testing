        ...
        <ScrollView horizontal={false}>
          ...
          >
            <Container
              ...
              useThemeGutterPadding={true}
            >
              <Button type="outline" color={theme.colors.strong} onPress={() => this.props.navigation.navigate('Mexico')}>
                Mexico City
              </Button>
            </Container>
            <Container
              ...
              useThemeGutterPadding={true}
            >
              <Button type="outline" color={theme.colors.strong} onPress={() => this.props.navigation.navigate('Beaches')}>
                Beaches
              </Button>
            </Container>
            <Container
              ...
              useThemeGutterPadding={true}
            >
              <Button type="outline" color={theme.colors.strong} onPress={() => this.props.navigation.navigate('Barcelona')}>
                Barcelona
              </Button>
            </Container>
          </ScrollView>
          <Container elevation={2} useThemeGutterPadding={false}>
            <Text
              style={[
                theme.typography.headline6,
                {
